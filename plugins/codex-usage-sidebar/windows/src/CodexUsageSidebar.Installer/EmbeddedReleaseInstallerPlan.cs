    ...
    TrustedPayloadIdentity TrustedIdentity)
{
        ...
        string codexRuntimeSha256)
    {
        ...
        {
            throw new PlatformNotSupportedException("Windows v0.3.3 releases support AMD64/x64 only.");
        }
        if (windowsBuild < 22_000)
        {
            throw new PlatformNotSupportedException("Windows v0.3.3 releases require Windows 11 build 22000 or newer.");
        }
