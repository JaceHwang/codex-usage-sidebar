...
public struct InstallerCopy: Equatable, Sendable {
    ...
    public static let english = InstallerCopy(
        ...
        version: "Version 0.2.3 · macOS arm64",
        install: "Install",
        repair: "Repair",
        uninstall: "Uninstall",
        ...
        readyMessage: "Ready to install the verified v0.2.3 payload.",
    ...
    public static let simplifiedChinese = InstallerCopy(
        ...
        readyMessage: "已准备安装经过验证的 v0.2.3 载荷。",
    ...
    public static let traditionalChinese = InstallerCopy(
        ...
        readyMessage: "已準備安裝經過驗證的 v0.2.3 載荷。",
