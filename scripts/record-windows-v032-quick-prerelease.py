...
VERIFIER = SCRIPT_DIRECTORY / "verify-windows-v032-quick-prerelease.py"
SPECIFICATION = importlib.util.spec_from_file_location("windows_v032_quick_verifier", VERIFIER)
...
def atomic_write(path: Path, document: dict[str, object]) -> None:
    ...
    with tempfile.NamedTemporaryFile("wb", dir=path.parent, prefix=".windows-v032-quick-", delete=False) as temporary:
