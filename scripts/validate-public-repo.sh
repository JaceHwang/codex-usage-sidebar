...
[[ -x "$repo_root/scripts/build-macos-v033-installer.sh" ]]
[[ -x "$repo_root/scripts/package-macos-v033-installer.sh" ]]
[[ -x "$repo_root/scripts/verify-macos-v033-installer-package.sh" ]]
